...
mixin _$UsersState on _UsersState, Store {
  ...
  final _$usersAtom = Atom(
    name: '_UsersState.users',
  );
  ...
  final _$imagefileAtom = Atom(
    name: '_UsersState.imagefile',
  );
  ...
  final _$_searchUserAtom = Atom(
    name: '_UsersState._searchUser',
  );
  ...
  final _$_UsersStateActionController = ActionController(
    name: '_UsersState',
  );
