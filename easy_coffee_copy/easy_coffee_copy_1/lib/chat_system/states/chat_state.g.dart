...
mixin _$ChatState on _ChatState, Store {
  ...
  final _$_ChatStateActionController = ActionController(
    name: '_ChatState',
  );
  ...
  void refreshChatForCurrentUser() {
    final _$actionInfo = _$_ChatStateActionController.startAction(
        name: '_ChatState.refreshChatForCurrentUser');
    try {
      return super.refreshChatForCurrentUser();
    } finally {
